...
class _OtpWidgetState extends State<OtpWidget> {
  ...
  void initState() {
    ...
    _model.textController ??= TextEditingController(text: 'Enter the OTP');
      ...
      child: Scaffold(
        ...
        body: Stack(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(0.0, 66.0, 114.0, 0.0),
              child: Column(
